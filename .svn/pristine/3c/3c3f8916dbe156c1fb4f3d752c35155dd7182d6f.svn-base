...
import com.gssinfotech.bone.mysecurity.MySecurityActivity;
import com.gssinfotech.bone.mysecurity.SensorActivity;
import com.gssinfotech.bone.mysecurity.SirenActivity;
...
public class MyDevicesAddDeviceActivity extends Activity{
	...
	public void onSaveButtonClicked(View v){
		...
		case 3:
			...
			//startActivity(new Intent(MyDevicesAddDeviceActivity.this, MySecurityActivity.class));
			break;
		case 4:
			//startSensorActivity();
			break;
	...
	public void startSensorActivity(){
		...
		Intent i=new Intent(MyDevicesAddDeviceActivity.this, SensorActivity.class);
		i.putExtras(b);
		startActivity(i);
	}
